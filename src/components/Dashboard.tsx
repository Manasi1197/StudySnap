...
import LingoTestPage from './LingoTestPage';
...
const Dashboard: React.FC<DashboardProps> = ({ currentPage = 'dashboard', onNavigate }) => {
  ...
  const sidebarItems = [
    ...
    { icon: Languages, label: 'Test Translation', page: 'lingo-test' },
  ...
  const renderMainContent = () => {
    ...
    switch (currentPage) {
      ...
      case 'lingo-test':
        return <LingoTestPage onBack={() => handleNavigation('dashboard')} />;
      case 'marketplace':
        return (
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        {/* Header - Show for all pages except Quiz Generator sub-pages and Lingo Test */}
        {!isInSubPage && currentPage !== 'lingo-test' && (
        ...
        {/* Dashboard Content */}
        <main className={`flex-1 ${!isInSubPage && currentPage !== 'quiz-generator' && currentPage !== 'study-rooms' && currentPage !== 'materials' && currentPage !== 'achievements' && currentPage !== 'settings' && currentPage !== 'help' && currentPage !== 'lingo-test' ? 'p-8' : ''}`}>
          {/* Conditional container width based on current page */}
          {currentPage === 'quiz-generator' || isInSubPage || currentPage === 'study-rooms' || currentPage === 'materials' || currentPage === 'achievements' || currentPage === 'settings' || currentPage === 'help' || currentPage === 'lingo-test' ? (
            // Full width for Quiz Generator, sub-pages, Study Rooms, Materials, Achievements, Settings, Help, and Lingo Test
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="bg-white rounded-xl p-6 border border-gray-200">
                      ...
                      <div className="space-y-3">
                        ...
                        <button 
                          onClick={() => handleNavigation('lingo-test')}
                          className="w-full flex items-center space-x-3 p-3 rounded-lg hover:bg-gray-50 transition-colors text-left"
                        >
                          <div className="w-8 h-8 bg-blue-500 rounded-lg flex items-center justify-center">
                            <Languages className="w-4 h-4 text-white" />
                          </div>
                          <span className="font-medium text-gray-900">Test Translation</span>
                        </button>
                      </div>
                    </div>
                  </div>
